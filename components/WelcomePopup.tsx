...
const WelcomePopup: React.FC<WelcomePopupProps> = ({ onClose }) => {
  return (
    ...
    >
      <div
        className="relative bg-black border-2 border-red-600/50 rounded-2xl w-full max-w-lg transform transition-all duration-300 animate-slide-up"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="p-6 sm:p-8 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-red-500 mb-2 tracking-wider">
            Congratulations!
          </h2>
          ...
          <div className="text-left bg-red-950/20 p-4 rounded-lg border border-red-500/20">
            <h3 className="font-bold text-red-400 text-lg mb-3">Getting Started:</h3>
            <ul className="space-y-2 text-gray-300 list-disc list-inside font-medium">
          ...
          <div className="mt-8">
            <NeonButton color="red" onClick={onClose}>
              Let's Go!
            </NeonButton>
          </div>
        </div>
