...
const PrivacyPolicy: React.FC = () => {
    return (
        <section className="bg-gray-800/50 p-6 sm:p-8 rounded-lg border border-red-500/30 w-full max-w-4xl mx-auto">
            ...
            <div>
                ...
                <PolicySection title="Third-Party Services (Advertising)">
                    ...
                    <ul className="list-disc list-inside space-y-2 pl-4">
                        ...
                        <li>
                            Users may opt out of personalized advertising by visiting <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-red-400 hover:underline">Ads Settings</a>.
                        </li>
                    </ul>
                    <p>
                        For more information, please review <a href="https://policies.google.com/technologies/ads" target="_blank" rel="noopener noreferrer" className="text-red-400 hover:underline">Google's advertising privacy policy</a>.
                    </p>
                </PolicySection>
