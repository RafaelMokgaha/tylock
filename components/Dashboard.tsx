...
type View = 'home' | 'request' | 'fix' | 'bypass' | 'help' | 'inbox' | 'library' | 'message' | 'available' | 'ubisoftBypass' | 'eaBypass' | 'rockstarBypass' | 'otherBypass';
  ...
  const handleViewChange = (view: View) => {
    if (view === 'inbox' || view === 'message') {
      try {
        ...
        console.error("Failed to parse messages from localStorage on view change:", error);
        localStorage.removeItem('messages');
        setUnreadMessages(0);
      }
    }
