...
const FaqItem: React.FC<{ question: string; children: React.ReactNode }> = ({ question, children }) => (
    <div className="mb-6 border-b border-red-500/20 pb-6">
...
const Help: React.FC = () => {
    return (
        <section className="bg-gray-800/50 p-6 sm:p-8 rounded-lg border border-red-500/30 w-full">
            <SectionHeader>Help &amp; Support</SectionHeader>
            <div>
                <FaqItem question="Installation Instructions">
                    <div className="space-y-4">
                        <div>
                            <h4 className="font-semibold text-red-300">Step 1: Download SteamTools</h4>
                            <p>
                            ...
                            <a
                                ...
                                className="inline-block mt-2 font-bold text-red-400 hover:text-red-300 transition-colors underline"
                            >
                                Download SteamTools
                            </a>
                        </div>
                        <div>
                            <h4 className="font-semibold text-red-300">Step 2: Request a Game</h4>
                            <p>
                                Use the "Request Game" button on the home screen to ask for a game. Once approved, it will appear in your Library.
                            </p>
                        </div>
                        <div>
                            <h4 className="font-semibold text-red-300">Step 3: Watch the Tutorial</h4>
                            <p>
                                Follow our video tutorial for a step-by-step guide on installation and setup.
                            </p>
                            <div className="relative mt-4 overflow-hidden rounded-lg border-2 border-red-500/30 shadow-lg" style={{ paddingBottom: '56.25%' }}>
                                <iframe
                        ...
                        <div>
                            <h4 className="font-semibold text-red-300">Step 4: Join our Discord Community</h4>
                            <p>
