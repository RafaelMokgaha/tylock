...
const NamePrompt: React.FC<NamePromptProps> = ({ onNameSubmit }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative bg-gray-900/80 backdrop-blur-sm border-2 border-red-500/50 rounded-2xl shadow-xl w-full max-w-md"
      >
        <div className="p-6 sm:p-8 text-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="relative">
              <UserIcon className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-red-400/50" />
              <input
                ref={inputRef}
                type="text"
                value={name}
                ...
                className="w-full pl-12 pr-4 py-3 bg-gray-900/70 border-2 border-red-500/30 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-red-500 transition-all duration-300"
              />
            </div>
